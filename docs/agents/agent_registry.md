...
## Operating Principle
Proceed by default using the best reasonable assumption. Ask only when the task requires credentials, paid spending, public publishing, irreversible deletion, private identity/voice use, or content that creates serious legal/policy/brand risk.
