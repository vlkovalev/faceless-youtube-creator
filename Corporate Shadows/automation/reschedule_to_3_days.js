...
// Spacing exactly at 3-day intervals starting from Video 2 (June 5) since we are now using Edge TTS (free)
const NEW_SCHEDULES = {
  'gPhHnEjKaP8': '2026-06-05T06:00:00.000Z', // Video 2 (Nestle)
  'PxBdlAu-hvY': '2026-06-08T06:00:00.000Z', // Video 3 (Phoebus Cartel)
  '-Tt_ijOCCRI': '2026-06-11T06:00:00.000Z', // Video 4 (Sugar Lobby)
  'ZM0fbdddYZA': '2026-06-14T06:00:00.000Z', // Video 5 (East India Company)
  'nlOlrWsHc9w': '2026-06-17T06:00:00.000Z', // Video 6 (Toxic Empire)
  'CXDTHbQVuPQ': '2026-06-20T06:00:00.000Z', // Video 7 (DuPont Teflon)
  '1TkYFsLq8QM': '2026-06-23T06:00:00.000Z'  // Video 8 (Monsanto Seeds)
};
...
async function main() {
  console.log('🔄 Starting YouTube Rescheduling to optimal 3-Day Cadence...\n');
  ...
  try {
    ...
    console.warn(`⚠️ Warning: Could not connect to YouTube API (${err.message}). Updating local files only.`);
  }
  ...
  console.log('\n🎉 Reverting to 3-day publishing cadence completely finished and synced!');
}
