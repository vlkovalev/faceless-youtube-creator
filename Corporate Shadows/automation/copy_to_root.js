...
try {
  ...
  // 3. Copy custom high-CTR thumbnail
  const thumbSrc = path.join(WORKSPACE_DIR, 'assets', 'youtube_thumbnail_video_6.png');
  const thumbDest = path.join(WORKSPACE_DIR, '..', 'youtube_thumbnail_video_6.png');
  fs.copyFileSync(thumbSrc, thumbDest);
  console.log('[OK] Successfully copied youtube_thumbnail_video_6.png -> youtube_thumbnail_video_6.png in root');
