...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: How to Automatically Track & Respond to B2B Competitor pricing using Web Scrapers

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: claude.
