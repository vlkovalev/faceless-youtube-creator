...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: How to Build a Telegram AI CRM Agent That Closes Clients

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: n8n, telegram, google sheets, claude, crm.
