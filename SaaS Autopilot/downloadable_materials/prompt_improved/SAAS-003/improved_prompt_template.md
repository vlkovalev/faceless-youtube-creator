...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: I Built a Voice AI Appointment Setter in 15 Minutes (Vapi + n8n)

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: n8n, vapi, crm.
