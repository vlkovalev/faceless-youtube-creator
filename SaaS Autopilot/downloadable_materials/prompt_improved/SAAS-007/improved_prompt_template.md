...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: Generative Engine Optimization (GEO): How to Rank #1 on ChatGPT & Perplexity

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: claude, perplexity, chatgpt.
