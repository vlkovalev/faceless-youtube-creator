...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: The 100% Free n8n VPS Setup (Stop Paying Make/Zapier)

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: n8n, zapier.
