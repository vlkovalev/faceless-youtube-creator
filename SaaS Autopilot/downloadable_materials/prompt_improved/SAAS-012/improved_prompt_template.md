...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: How to Automate B2B Invoice & Receipt Processing Using OCR & LLMs

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: claude, ocr.
