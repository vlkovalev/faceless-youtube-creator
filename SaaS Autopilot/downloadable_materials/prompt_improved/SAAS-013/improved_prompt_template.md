...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: I Built a Slack Sales Assistant That Alerts Reps and Drafts Pitch Decks

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: slack, claude.
