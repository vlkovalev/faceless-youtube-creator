...
# CONTEXT & OBJECTIVE
Build a practical automation blueprint for: The $20/Month Stack That Replaced a $3,000 Marketing Agency

The workflow should help {{target_customer}} reduce {{manual_task}} and produce {{business_outcome}} using this likely stack: make.com, linkedin, claude.
